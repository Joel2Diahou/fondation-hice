...
# === FIX : Supprimer les caractères BOM dans routes/web.php ===
RUN sed -i '1s/^\xEF\xBB\xBF//' /var/www/html/routes/web.php
...
# Forcer un fichier web.php propre
RUN echo '<?php' > /var/www/html/routes/web.php \
